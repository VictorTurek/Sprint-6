...
export class ServicesOfferedService {
  ...
  objects: serviceType[] = [
    { id: 0, title: 'SEO', description: "Analisis SEO d'una pagina web", price: 300, options: ["Quantitat de pagines", "Quantitat de idiomes"] },
  ...
  getObjects(): serviceType[] {
    return this.objects.map(service => ({ ...service, selected: false }));
  }
